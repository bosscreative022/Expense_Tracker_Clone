...
export default function AddExpense({ navigation }: any) {
 ...
 const handleConfirm = () => {
            ...
            <View style={styles.stepOneWrapper}>
              <View style={styles.stepOneCenter}>
                ...
                <View style={styles.amountWrapper}>
                  <IndianRupee size={36} color="#621926" strokeWidth={2} style={styles.currencyIcon} />
                  <TextInput
                    autoFocus
                    value={amount}
    ...
    >
      ...
      <View style={styles.dateContainer}>
        <View style={styles.dateIconWrapper}>
          <Calendar color="#f43f5e" size={18} strokeWidth={2} />
        </View>
  ...
  <Pressable
    style={[
      styles.confirmBtn, 
      isReporting && { backgroundColor: '#f43f5e' } // Optional: Darken button when reporting
    ]}
